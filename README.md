...
```bash
docker pull sameersbn/postgresql:13-20221205
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:13-20221205 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:13-20221205 -c logging_collector=on
```
