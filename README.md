...
# sameersbn/postgresql:15-20230112
...
```bash
docker pull sameersbn/postgresql:15-20230112
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:15-20230112 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:15-20230112 -c logging_collector=on
```
